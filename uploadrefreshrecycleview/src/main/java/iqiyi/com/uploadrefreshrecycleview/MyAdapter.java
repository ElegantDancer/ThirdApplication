...
public class MyAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public MyAdapter(Context context, List<String> datas, boolean hasMore) {
        this.datas = datas;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == normalType) {
            return new NormalHolder(LayoutInflater.from(context).inflate(R.layout.recyc_item, null));
        } else {
            return new FootHolder(LayoutInflater.from(context).inflate(R.layout.foot_view, null));
        }
    }
